package com.lee_idle.viewmodeldemo
...
import com.lee_idle.viewmodeldemo.ui.theme.ViewModelDemoTheme
...
fun InputRow(
    ...
    Row(verticalAlignment = Alignment.CenterVertically) {
        ...
        Crossfade(
            ...
            when (visible) {
                true -> Text(text = "\u2109", style = MaterialTheme.typography.bodyLarge)
